...
--   여기 시드는 기본 도감 15종에 대응한다(아래 t_hobby와 bbsinfo_id로 짝을 맞춘다).
...
VALUES
    ...
    (8, '러닝', 'BBSINFO001', '러닝 모임·정보 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1'),
    (9, '크로스핏', 'BBSINFO001', '크로스핏 정보·모임 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1'),
    (10, '클라이밍', 'BBSINFO001', '클라이밍 정보·모임 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1'),
    (11, '요가', 'BBSINFO001', '요가 정보·모임 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1'),
    (12, '캠핑', 'BBSINFO001', '캠핑 정보·모임 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1'),
    (20, '사진', 'BBSINFO001', '사진 정보·모임 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1'),
    (21, '베이킹', 'BBSINFO001', '베이킹 정보·모임 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1'),
    (22, '기타', 'BBSINFO001', '기타 정보·모임 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1'),
    (23, '자전거', 'BBSINFO001', '자전거 정보·모임 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1'),
    (24, '서핑', 'BBSINFO001', '서핑 정보·모임 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1'),
    (25, '도예', 'BBSINFO001', '도예 정보·모임 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1'),
    (26, '배드민턴', 'BBSINFO001', '배드민턴 정보·모임 공유', 10, 'Y', 5, 10, 'N', 7, 'Y', 'system', 'system', NOW(), NOW(), '127.0.0.1', '127.0.0.1');
